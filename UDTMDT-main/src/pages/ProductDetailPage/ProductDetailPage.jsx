...
const ProductDetailPage = () => {
    ...
    // --- XỬ LÝ MUA HÀNG & GIỎ HÀNG (GỘP CHUNG LOGIC) ---
    ...
    return (
        <div style={{ width: '100%', background: '#efefef', minHeight: '100vh', paddingBottom: '40px' }}>
            ...
            {/* --- [FIX QUAN TRỌNG] SẢN PHẨM TƯƠNG TỰ (DÙNG ROW/COL ĐỂ GÓI GỌN) --- */}
                    ...
                    <div style={{ padding: '10px' }}>
                        <Row gutter={[16, 16]}> 
                            {relatedProducts.map((product) => {
                                ...
                                return (
                                    // xl={4} nghĩa là 24/4 = 6 sản phẩm/hàng trên màn hình lớn
                                    // lg={6} nghĩa là 24/6 = 4 sản phẩm/hàng trên laptop
                                    // md={8} nghĩa là 24/8 = 3 sản phẩm/hàng trên tablet
